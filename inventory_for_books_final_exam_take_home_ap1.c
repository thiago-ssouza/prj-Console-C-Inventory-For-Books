...
// Finilizing the purchase
void finalize_purchase(int, int, int);
    ...
    if(count_found > 1){
        ...
        do{
            ...
            if(isbn_index == -1){
                ...
                if(isListed){
                    print_book(isbn_index);
                    finalize_purchase(isbn_index, choice, transaction_type);
                }else{
        ...
        finalize_purchase(indexes_found[count_found - 1], choice, transaction_type);
    }
}
...
// Finilizing the purchase
void finalize_purchase(int isbn_index, int choice, int transaction_type) {
